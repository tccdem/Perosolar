...
df_test = pd.read_csv("ElimPredictionsTest_768.csv")
testReal = df_test.iloc[:, 0]
testPred = df_test.iloc[:, -1]

df_train = pd.read_csv("ElimPredictionsTrain_768.csv")
...
plt.minorticks_on()
plt.tight_layout()
plt.savefig("Cubic_BG_LAD768.pdf", dpi=600, bbox_inches="tight")
